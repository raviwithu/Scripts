...
t = PrettyTable(['Test Case Id', 'Name', 'Status'])
...
def banner_grap(target, fuzz_data_logger, session, sock): 
    ...
    fuzz_data_logger.log_info(blocks.CURRENT)
    ...
    conn.close()
    '''
    test_case_fuzz_id, test_case_fuzz_name = (fuzz_data_logger._cur_test_case_id).split(":")
    t.add_row([test_case_fuzz_id, test_case_fuzz_name,target_active_flag])
#WiFi Frame
